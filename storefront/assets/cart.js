...
class CartItems extends HTMLElement {
  constructor() {
    super();
    this.lineItemStatusElement = document.getElementById('Cart-LineItemStatus');
  ...
  updateQuantity(line, quantity, name, variantId) {
    ...
    fetch(`${routes.cart_change_url}`, { ...fetchConfig(), ...{ body } })
      ...
      .then((state) => {
        ...
        const quantityElement = document.getElementById(`CartQuantity-${line}`);
      ...
      .catch(() => {
        ...
        const errors = document.getElementById('CartErrors');
  ...
  updateLiveRegions(line, message) {
    ...
    const cartStatus = document.getElementById('Cart-LiveRegionText');
  ...
  enableLoading(line) {
    const mainCartItems = document.getElementById('Cart-CartItems');
